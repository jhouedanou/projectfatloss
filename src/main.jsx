...
// Initialiser le service de notifications avec gestion d'erreur simplifiée
try {
  // Initialiser immédiatement au lieu d'attendre
  ...
  console.warn('Erreur service notification:', error);
}
